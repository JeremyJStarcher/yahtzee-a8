...
_EXPECTED_START_CHAR_RAM = 0xA000
_EXPECTED_END_CHAR_RAM = _EXPECTED_START_CHAR_RAM + _EXPECTED_SCREEN_SIZE  # $A3C0
_EXPECTED_START_COLOR_RAM = 0xB000
_EXPECTED_END_COLOR_RAM = _EXPECTED_START_COLOR_RAM + _EXPECTED_SCREEN_SIZE  # $B3C0
